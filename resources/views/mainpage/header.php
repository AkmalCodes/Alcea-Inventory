    ...
    <div class="container">
        ...
        <div class="top-nav-menu-right col-6 col-md-4 mt-3 mt-md-0">
            <div class="container-fluid d-flex justify-content-around">
                ...
                <a href="#" class="login-show btn d-none align-items-center d-md-flex">
            ...
            <ul class="mobile-menu-list">
                ...
                <li class="mobile-has-submenu">
                    ...
                    <ul class="mobile-submenu">
                        ...
                        <li><a href="#">Inventory 1.111</a></li>
                        <li><a href="#">Inventory 1.12</a></li>
                        <li><a href="#">Inventory 1.311</a></li>
                        <li><a href="#">Inventory 1.12</a></li>
                        <li class="mobile-has-submenu">
                            <a href="#">Inventory</a>
                            <ul class="mobile-submenu">
